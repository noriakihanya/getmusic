...
inst_to_row = {
    '80':0, '32':1, '128':2, '25':3, '0':4, '48':5, '129':6
}
prog_to_abrv = {
    '0':'P','25':'G','32':'B','48':'S','80':'M','128':'D'
}
...
kind_dict = {
    'null': 0, 'm': 1, '+': 2, 'dim': 3, 'seven': 4, 'maj7': 5, 'm7': 6, 'm7b5': 7
}
...
conditional_name = select_condition_tracks
condition_inst = []
...
content_name = --select_content_tracks
...
save_path = os.path.join(args.output_midi, '{}2{}-{}'.format(conditional_name, content_name, file_name.split('/')[-1]))
